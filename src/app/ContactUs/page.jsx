            ...
            <form id={styles.contactForm}>
              ...
              <div className={styles.inputbox}>
                <textarea 
                  ...
                  name="" 
                  placeholder={
                    feedbackType === 'bug' ? "Please describe the bug and steps to reproduce it..." :
                    feedbackType === 'ui' ? "Please describe your UI suggestion..." :
                    feedbackType === 'other' ? "Please provide your feedback..." :
