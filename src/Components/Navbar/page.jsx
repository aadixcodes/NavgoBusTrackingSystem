      ...
      <nav className={`${styles.navbar} ${isScrolled ? styles.navbarScrolled : ''}`}>
        <div className={styles.navbarContent}>
          <div className={styles.navbarInner}>
            ...
            <div className={styles.desktopNavigation}>
              <Link className={styles.navLink} href="/BusBoard">
                Bus Board
              </Link>
              <Link className={styles.navLink} href="/AboutUs">
                About Us
              </Link>
              <Link className={styles.navLink} href="/Notification">
                Notification
              </Link>
        ...
        >
          <div className={styles.mobileNavContent}>
            <Link className={styles.mobileLinkItem} href="/BusBoard">
              Bus Board
            </Link>
            <Link className={styles.mobileLinkItem} href="/AboutUs">
              About Us
            </Link>
            <Link className={styles.mobileLinkItem} href="/Notification">
              Notification
            </Link>
            <Link className={styles.mobileLinkItem} href="/Login">
              Sign In
            </Link>
            <Link className={styles.mobileSignupLink} href="Signup">
              Sign Up
            </Link>
          </div>
        </div>
