  ...
  return (
    <div className={`${styles.sidebar} ${isOpen ? styles.open : ""}`}>
      ...
      <nav className={styles.nav} onClick={onClose}>
        ...
        <Link href="/viewroutes">View Bus Routes</Link>
        <Link href="/ContactUs">Contact Us</Link>
        <Link href="/livetracking" className="bg-[#FACC15] text-black px-4 py-2 rounded-md hover:bg-[#FDE047] hover:text-black"> Track Your Bus</Link>
      ...
      <div className={styles.profileSection} >
        {isSettingsBoxOpen && (
          <div className={styles.settingsBox} ref={settingsBoxRef} onClick={onClose}>
            ...
            <Link href="/UserProfile" className="hover:text-[#FDE047]">Profile</Link>
